...
def Online_updating_EEGNet_simulation(args_dict):
    ...
    # this is the implementation of the EEG-OTTA
    # paper: Wimpff M, Döbler M, Yang B. Calibration-free online test-time adaptation for electroencephalography motor imagery decoding[C]//2024 12th International Winter Conference on Brain-Computer Interface (BCI). IEEE, 2024: 1-6.

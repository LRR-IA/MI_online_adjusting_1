...
def Online_updating_EEGNet_simulation(args_dict):
    ...
    n_epoch_online_1 = args_dict.n_epoch_online_1
    batch_size = args_dict.batch_size
    ...
    for trial_idx in range(trial_nums):
        ...
        if (trial_idx + 1) % update_trial == 0:           
            ...
            if (trial_idx+1) % update_wholeModel == 0:
                ...
                _n_epoch_online = n_epoch_online_1
...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_epoch_online', default=2, type=int, help="number of epoch for distillation updating")
    parser.add_argument('--n_epoch_online_1', default=4, type=int, help="number of epoch for MMD contrastive updating")
    ...
    n_epoch_online_1 = args.n_epoch_online_1
    ...
    args_dict.n_epoch_online_1 = n_epoch_online_1

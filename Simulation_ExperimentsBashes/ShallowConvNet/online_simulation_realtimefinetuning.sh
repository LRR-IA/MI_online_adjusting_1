...
# 你的程序的路径
program_path="Online_simulation/Online_realtimefinetuning.py"
...
do
  ...
  python3 $program_path \
    ...
    --Online_result_save_rootdir "Online_simulation_experiments/ShallowConvNet/ShallowConvNet_realtimefinetuning" \
    --restore_file "None" \
    --n_epoch_offline 32 \
    --n_epoch_online 2 \
    --batch_size 16 \

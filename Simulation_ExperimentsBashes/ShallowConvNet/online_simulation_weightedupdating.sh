...
# 你的程序的路径
program_path="Online_simulation/Online_weightedupdating.py"
...
do
  ...
  python3 $program_path \
    ...
    --Online_result_save_rootdir "Online_simulation_experiments/ShallowConvNet/ShallowConvNet_Weightedupdating" \

...
program_path="Online_simulation/Online_ftotta_1.py"
...
do
  ...
  do
    ...
    Online_result_save_rootdir="Online_simulation_experiments/ShallowConvNet/ShallowConvNet_Online_FTOTTA_2"
    for i in $(seq 1 25)
    do

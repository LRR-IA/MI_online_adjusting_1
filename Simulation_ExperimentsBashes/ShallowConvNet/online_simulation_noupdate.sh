...
program_path="Online_simulation/Online_noupdate.py"
...
do
  ...
  do
    ...
    Online_result_save_rootdir="Online_simulation_experiments/ShallowConvNet/ShallowConvNet_Online_noupdate"
    for i in $(seq 1 25)
    do

...
# 你的程序的路径
program_path="Online_simulation/Online_train_EEGNet_simulation_method5_baseline_2_9_9batchsize_Rest_2_mixed_3_2.py"
...
do
  ...
  python3 $program_path \
    ...
    --Online_result_save_rootdir "Online_simulation_experiments/method5_EEGNet_baseline_2_9_9batchsize_Rest_2_mixed_3_new_1_3407_1_2" \

...
# 你的程序的路径
program_path="Online_simulation/Online_train_EEGNet_simulation_method5_baseline_1_2_9batchsize_Rest_2_mixed_3.py"
...
do
  ...
  python3 $program_path \
    ...
    --Online_result_save_rootdir "Online_simulation_experiments/method5_EEGNet_baseline_1_2_9batchsize_Rest_2_mixed_3_new_4_seed3407" \
    --restore_file "None" \
    --n_epoch_offline 32 \
    --n_epoch_online 2 \
    --batch_size 16 \

...
# 超参数列表
T_distil_list=(2 4 8)  # different temperature values for distillation
tau_cons_list=(4 6 8 10 16 32)  # different consistency loss weights
...
do
  ...
  do
    ...
    Online_result_save_rootdir="Online_simulation_experiments/EEGNet/epoches_sensitivity/EEGNet_Online_adaptive_algorithm/${result_subfolder}"
    for i in $(seq 1 25)
    do
      ...
      python3 $program_path \
        ...
        --trial_pre 120 \
        --proportion 0.75 \
        --Offline_result_save_rootdir "Offline_simulation_experiments/EEGNet/method2_EEGNet_val_classval_pretrainlight_unfreeze_new_seed3407" \

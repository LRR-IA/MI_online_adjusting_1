...
# 你的程序的路径
program_path="Online_simulation/Online_train_EEGNet_simulation_method4_fixedepoch_FeatureDistillation_val_9batchsize_Rest_2_mixed_retrain.py"
...
do
  ...
  python3 $program_path \
    ...
    --Online_result_save_rootdir "Online_simulation_experiments/method4_EEGNet_fixedepoch_FeatureDistillation_val_9batchsize_Rest_2_mixed_retrain_new_3407" \
    --restore_file "None" \
    --n_epoch_offline 32 \
    --n_epoch_online  8 \
    --batch_size 16 \
